...
class ResNetGauss(nn.Module):
    def __init__(self, block, num_blocks, num_classes=10, num_prot=1):
        ...
        self.classifier = Gauss(512*block.expansion, num_classes*num_prot, num_classes)
...
def ResNet18Gauss():
    return ResNetGauss(BasicBlock, [2,2,2,2])

def ResNet34Gauss():
    return ResNetGauss(BasicBlock, [3,4,6,3])

def ResNet50Gauss():
    return ResNetGauss(Bottleneck, [3,4,6,3])

def ResNet101Gauss():
    return ResNetGauss(Bottleneck, [3,4,23,3])

def ResNet152Gauss():
    return ResNetGauss(Bottleneck, [3,8,36,3])
